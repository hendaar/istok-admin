...
class Contractor_edit extends CI_Controller {
	...
	public function __construct() {
		...
		$this->load->database();
		$this->load->model('Model_contractor_edit');
	...
	public function index($id)	{
		...
		$data_all = $this->Model_contractor_edit->get_data($id);
		$data['data_all'] = $data_all;

		$dd_department = $this->Model_contractor_edit->get_list_department();
		$data['dd_department'] = $dd_department;
		
		$this->load->view('header', $datasesion);
		$this->load->view('contractor_edit', $data);
	...
	public function simpan($id)	{
		...
		if ($this->form_validation->run() == FALSE){
			...
			if ($this->Model_contractor_edit->update_data($data, $contractor_id)){
